    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10 offset-2">
                <h3>Chi tiết đăng ký tiêm vắc xin</h3>
                            ...
                            <div class="row">
                                <div class="col">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <th>CMND/CCCD:</th>
                                            <td><?= $ttKH->cmnd == "000000000000" ? "Không" : $ttKH->cmnd?></td>
                                        </tr>
                                        <tr>
                                            <th>Địa chỉ:</th>
                                ...
                                <div class="col">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $ttKH->solantiem == 0 ? "Không" : $vaccine->find($ttKH->vaccinedatiem)->ten ?></td>
                                        </tr>
                                        <tr>
                                            <th>Người giám hộ:</th>
                                            <td><?=  $ttKH->nt_id != "" ? $ngh->find($ttKH->nt_id)->hoten : "Không"?></td>
                                        </tr>
                                        <tr>
                                            <th>Số điện thoại:</th>
                                            <td><?=  $ttKH->nt_id != "" ? $tk->findByNDID($ttKH->nt_id)->sdt : $tk->findByNDID($ttKH->layId())->sdt?></td>
                                        </tr>
